...
eval_dataset_ceilnet = datasets.CEILTestDataset(join(datadir, 'Berkeley Real'))
...
res = engine.eval(eval_dataloader_ceilnet, dataset_name='Berkeley Real', savedir=join(result_dir, 'Berkeley Real'))
